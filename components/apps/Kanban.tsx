                ...
                <div key={column.id} className="w-80 flex flex-col h-full max-h-full">
                    ...
                    <div className="flex-1 overflow-y-auto pr-2 pb-2 space-y-3 custom-scrollbar">
                        {column.tasks.map((task) => (
                            <div 
                                key={task.id} 
                                className="bg-white p-4 rounded-xl border border-gray-200 shadow-sm hover:shadow-md hover:border-brand-300 transition-all cursor-grab active:cursor-grabbing group"
                            >
